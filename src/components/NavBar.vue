<template>
    <nav
        class="fixed z-30 top-0 h-16 min-w-max w-full px-10vw lg:px-10 flex items-center justify-center backdrop-saturate-150 backdrop-blur-lg transition-all duration-300 ease-linear bg-theme-base bg-opacity-80"
    >
