<template>
    ...
    <transition name="playerDrag-out">
        <div
        ...
        >
            ...
            <div class="flex flex-col h-full px-4">
                ...
                <div class="flex items-center">
                    <div class="w-24 h-24">
                        <img
                            class="rounded-lg align-middle object-cover shadow-lg transition duration-300 origin-center"
                    ...
                    <div class="flex flex-col flex-1 px-2">
                        ...
                        ></div>
                        <div class="text-sm opacity-80" v-if="currentTrack.ar">
                            <span v-for="(item, index) in currentTrack.ar" :key="item.id">
                                <i v-if="index !== 0"> / </i>
...
.playerDrag-out-enter-active,
.playerDrag-out-leave-active {
    @apply opacity-100 scale-100 transition ease-linear;
}
.playerDrag-out-enter-from,
.playerDrag-out-leave-to {
