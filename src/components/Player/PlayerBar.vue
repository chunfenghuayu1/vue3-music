<template>
    <div
        class="sticky bottom-0 left-0 right-0 h-16 z-50 backdrop-saturate-150 backdrop-blur-lg transition-all duration-300 ease-linear bg-theme-base bg-opacity-80 flex flex-col"
    >
        <!-- 进度 -->
        <div
        ...
        <div class="px-10vw flex-1 flex justify-between text-theme-base">
            ...
            <div class="flex items-center h-full flex-1">
                ...
                <div class="flex-col flex justify-center px-4">
                    ...
                    <div class="text-xs opacity-60 font-semibold">周杰伦</div>
                </div>
            </div>
...
const { isPlaying, playOrPause, nextOrPrePlay, sliderVolume, sliderProgress } = usePlay()
</script>
