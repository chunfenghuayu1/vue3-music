<template>
    <div class="mt-16">
        ...
        <div class="grid grid-cols-2 gap-x-6 h-48">
            <!-- 每日推荐 -->
            <div
                class="rounded-lg bg-no-repeat bg-top animate-move-y flex items-center justify-between min-w-max cursor-pointer"
            ...
            >
                ...
                <div class="flex items-end h-full px-1/20 py-4">
                    <div
                    ...
                    >
                        <SvgIcon icon-name="play" icon-size="40"></SvgIcon>
                    </div>
                </div>
            </div>
            <!-- 热评 -->
...
const picUrl = computed(() => {
    let img = [
        'http://p4.music.126.net/u0m8olOKfHHLKsWidtuQCw==/109951167732746957.jpg',
        'http://p3.music.126.net/JE3DYh_gqRIiAyhWAEWRjw==/109951167596992903.jpg',
        'http://p3.music.126.net/t05hLDCz72CkGkH6XcOUfA==/109951167606527269.jpg'
    ]
    return `${sample(img)}?param=1024y1024`
})
</script>
