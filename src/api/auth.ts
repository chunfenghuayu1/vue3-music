 ...
 * 说明: 调用此接口可生成一个 key
 */
export const reqLoginKey = (params: LoginKey) => http.post({ url: Api.LoginKey, params })
 ...
 */
export const reqLoginQRCode = (params: LoginQRCode) => http.post({ url: Api.LoginQRCode, params })
 ...
 *
 */
export const reqLoginCheck = (params: LoginQRCode) => http.post({ url: Api.LoginCheck, params })
